        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header" style="margin-top: 20px;">
                    <div  style="margin-left: 470px"><h1>加班审核</h1></div>
                </div>
                <div class="layui-card-body">
                        ...
                        <div class="layui-form-item" style="margin-top: 20px;">
                            <table id="tableY" >
                                ...
                                <tr>
                                    ...
                                    <td>申请时间</td>
                                    <td colspan="2">${list.apoverdate}</td>
                                </tr>
                                <tr>
                                    <td>加班类型</td>
                                    <td colspan="2">${list.apovtype}</td>
                                    <td>加班时长</td>
                                    <td colspan="2">${list.apovhour}</td>
                                </tr>
                                <tr>
                                    <td>时间范围</td>
                                    <td colspan="5">${list.apovstartdate}</td>
                                </tr>
                                <tr >
                                    <td >加班理由</td>
                                    <td colspan="5" style="height: 150px;">
                                        <textarea name="address" placeholder="请输入内容" style="width: 700px;height: 150px;" class="layui-textarea">${list.apovreason}</textarea>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="demoTable layui-form">
                        <div class="layui-inline">
                            ...
                            <input value="${list.apovid}" id="b" style="display: none;">
...
<script>
    function pass() {
        ...
        $.ajax({
            url:'UpdateOvertimeYqx',
            type:'post',
            data:{"apovid":apovid,"name":name,"data":currentdate},
            dataType:'text',
            success:function (data) {
                alert(data+"ggggggggggggggg")
                window.location.href="QManageOvertime"
            }
        })
    }
    function TurnDown() {
