...
<div class="demoTable layui-form">
    <div class="layui-inline">
        <a href="L_sh_leave" style="color: #009688;" class="layui-btn layui-btn-primary">休假审批</a>
    </div>
    <div class="layui-inline">
        <a href="L_sh_jiaban"   class="layui-btn layui-btn-primary">加班审批</a>
    </div>
    <div class="layui-inline">
        <a href="L_sh_lizhi" class="layui-btn layui-btn-primary">离职审批</a>
    </div>
    <div class="layui-inline">
    ...
    <div   style="margin-left:350px" class="layui-btn" data-type="reload"><a href="L_yishen_leave">已审批</a></div>
</div>
        ...
        var $ = layui.$, active = {
            reload: function(){
                ...
                table.reload('testReload', {
                    ...
                    ,where: {
                        time1:$("#test1").val(),time2:$("#test2").val(),deptid:dept, leasate:0
                    }
                });
            }
        };
                ...
                layer.open({
                    ...
                    btn1: function(index,layero){
                        ...
                        if(zhi==""){
                            ...
                            $.ajax({
                                ...
                                data: {"bohui":$("#bohui").val(),"pipeople":$("#pipeople").val(),"leasate":1,"leaid":leaid},
                                type: 'POST',
                                dataType: "text",
                    ...
                    btn2:function(index,layero){
                        ...
                        if(zhi==""){
                            ...
                            $.ajax({
                                url: 'L_upd_xiujia_unpass',
                                data: {"bohui":$("#bohui").val(),"pipeople":$("#pipeople").val(),"leasate":2,"leaid":leaid},
                                type: 'POST',
                                dataType: "text",
                                success: function (data) {
                                    if(data="chenggong"){
