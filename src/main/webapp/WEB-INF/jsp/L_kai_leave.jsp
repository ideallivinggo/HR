...
<div class="demoTable layui-form">
    <div class="layui-inline">
        <a href="L_kai_jiaban"   class="layui-btn layui-btn-primary">加班</a>
    </div>
    <div class="layui-inline">
        <a href="L_kai_leave" style="color: #009688;" class="layui-btn layui-btn-primary">休假</a>
    </div>
    <div class="layui-inline">
    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                , {field: 'leaenterdate', width:480, title: '请假时间段'}
                , {field: 'deptname', title: '部门', width: 150}
                , {field: 'leasate', title: '审核状态', width: 140,templet:function(d){
                    return d.leasate == "4" ? "已通过": d.leasate=="2" ? "驳回" : "审核中"
                }}
        ...
        table.on('tool(dome)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'edit'){
                layer.open({
                    ...
                    area: ['800px', '500px'],
                    btn: ['关闭'],
                    content: '<div id="cont">姓名：<span >'+data.empname+'</span>&nbsp&nbsp&nbsp&nbsp<span style="font-size: 12px">'+data.shendate+'</span><br><br>' +
