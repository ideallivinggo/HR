        ...
        table.render({
            ...
            ,cols: [[
                ...
                , {field: 'kstate', title: '审核状态', width: 160,templet:function(d){
                    return d.kstate == "4" ? "已通过": d.kstate=="2" ? "驳回" : "审核中"
                }}
        ...
        table.on('tool(dome)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'edit'){
                layer.open({
                    ...
                    area: ['800px', '520px'],
                    btn: ['详情'],
                    content: '<div id="cont">课程描述：<span>'+data.kemiaoshu+'</span><br><br>' +
                    ...
                    '审核理由：<span>'+data.bohui+'</span><br><br>' +
                    '总经理审批/审批时间：<span>'+data.zongshen+'/</span><span>'+data.zongshendate+'</span><br><br>' +
                    '审批理由：<span>'+data.zongbohui+'</span><br><br></div>',
