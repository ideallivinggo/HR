        ...
        table.on('tool(dome)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'edit'){
                layer.open({
                    ...
                    '一级审核/审核时间：<span>'+data.pipeople+'/</span><span>'+data.pidate+'/</span><br><br>' +
                    ...
                    btn1: function(index,layero){
                        ...
                        if(zhi==""){
                            ...
                            $.ajax({
                                url: 'L_upd_zong_out',
                                data: {"zongbohui":$("#zongbohui").val(),"zongshen":$("#zongshen").val(),"offstate":5,"offid":offid},
                                type: 'POST',
                                dataType: "text",
                    ...
                    btn2:function(index,layero){
                        ...
                        if(zhi==""){
                            ...
                            $.ajax({
                                url: 'L_upd_zong_out',
                                data: {"zongbohui":$("#zongbohui").val(),"zongshen":$("#zongshen").val(),"offstate":2,"offid":offid},
                                type: 'POST',
                                dataType: "text",
                                success: function (data) {
                                    if(data="chenggong"){
