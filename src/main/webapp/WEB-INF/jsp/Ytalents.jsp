...
电话：8888888 岳三金 15837389710
                        ...
                        <input type="button" class="layui-btn layui-btn-fluid" onclick="sendmail()" value="发送邮件"
...
<script>
    ...
    function queryAllRes(pageNum) {
        ...
        $.ajax({
            url: "queryAllResYLP",
            type: "post",
            data:{resstate:1,education:xueli,sex:xingbie,pageNum:pageNum},
            dataType: "json",
            async:false,
