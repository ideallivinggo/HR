...
<div class="demoTable layui-form">
    ...
    <div class="layui-inline">
        <a href="L_sh_jiaban" style="color: #009688;"  class="layui-btn layui-btn-primary">加班审批</a>
    </div>
    <div class="layui-inline">
    ...
    <div  style="margin-left:350px" class="layui-btn" data-type="reload"><a href="L_yishen_jiaban">已审批</a></div>
</div>
                    ...
                    btn1: function(index,layero){
                        ...
                        if(zhi==""){
                            ...
                            $.ajax({
                                ...
                                data: {"bohui":$("#bohui").val(),"pipeople":$("#pipeople").val(),"apovstate":1,"apovid":apovid},
                                type: 'POST',
                                dataType: "text",
