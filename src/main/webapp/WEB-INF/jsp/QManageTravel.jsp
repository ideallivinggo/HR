...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-sm layui-btn-normal" lay-event="edit">出差审核</a>
</script>
            ...
            <div class="layui-card">
                <div class="layui-card-header" style="height: 60px;padding-top: 15px;">
                    <div class="demoTable layui-form">
                        ...
                        <div class="layui-inline">
                            <a href="QManageTravel" style="color: #009688;" class="layui-btn layui-btn-primary">出差管理</a>
                        </div>
                        <div class="layui-inline">
    ...
    layui.use(['form', 'layedit', 'laydate','table','layer'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'offgoods', title: '申请出差理由', align:'center'}
            ...
            if(obj.event === 'edit'){
                $.ajax({
                    ...
                    success:function (data) {
                        window.location.href="QManageTravelD"
                    }
                })
            }
        });
