...
<body>
  ...
  <div id="body" style="border-radius:10px;position: absolute;top:35%;left:8%;width:84%;height: 900px;background-color: #ffffff">
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header" style="margin-top: 20px;">
                    <div  style="margin-left: 470px"><h1>转正审核</h1></div>
                </div>
                <div class="layui-card-body">
                            ...
                            <div class="layui-form-item" style="margin-top: 20px;">
                                <table id="tableY" >
                                    ...
                                    <tr>
                                        ...
                                        <td>申请时间</td>
                                        <td colspan="2">${list.empnumber}</td>
                                    </tr>
                                    <tr >
                                        <td >申请内容</td>
                                        <td colspan="5" style="height: 150px;">
                                            <textarea name="address" placeholder="请输入内容" style="width: 700px;height: 150px;" class="layui-textarea">${list.shentext}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="demoTable layui-form">
                        <div class="layui-inline">
                            ...
                            <input value="${list.shenid}" id="b" style="display: none;">
...
<script>
    function pass() {
        ...
        $.ajax({
            url:'UpdateTurnYqx',
            type:'post',
            data:{"empid":empid,"shenid":shenid,"name":name,"data":currentdate},
            dataType:'text',
