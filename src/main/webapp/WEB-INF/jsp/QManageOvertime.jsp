...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-sm layui-btn-normal" lay-event="edit">加班审核</a>
</script>
                ...
                <div class="layui-card-header" style="height: 60px;padding-top: 15px;">
                    <div class="demoTable layui-form">
                        <div class="layui-inline">
                            <a href="QManageLeave" class="layui-btn layui-btn-primary">请假管理</a>
                        </div>
                        <div class="layui-inline">
                            <a href="QManageOvertime" style="color: #009688;" class="layui-btn layui-btn-primary">加班管理</a>
                        </div>
                        <div class="layui-inline">
    ...
    layui.use(['form', 'layedit', 'laydate','table','layer'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'apovtype', title: '加班类型', align:'center'}
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'edit'){
                $.ajax({
                    url:'QueryOvertimeDYqx',
                    type:'post',
                    data:{"empid":empid},
                    dataType:'json',
                    success:function (data) {
                        window.location.href="QManageOvertimeD"
                    }
                })
            }
        });
