...
<div class="demoTable layui-form">
    ...
    <div class="layui-inline">
        <a href="L_kai_lizhi"   style="color: #009688;" class="layui-btn layui-btn-primary">离职</a>
    </div>
    <div class="layui-inline">
        申请时间:<input readonly="readonly" type="text" id="test1"/>至
        <input readonly="readonly" type="text" id="test2"/>
        <input id="empid" value="${emp.empid}" hidden>
    </div>
        ...
        var $ = layui.$, active = {
            reload: function(){
                ...
                table.reload('testReload', {
                    ...
                    ,where: {
                        time1:$("#test1").val(),time2:$("#test2").val(), "empid":aa
                    }
                });
            }
        };
