...
<div id="body" style="border-radius:10px;position: absolute;top:35%;left:8%;width:84%;height: 1050px;background-color: #ffffff">
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header" style="margin-top: 20px;">
                    <div  style="margin-left: 470px"><h1>离职审核</h1></div>
                </div>
                <div class="layui-card-body">
                        ...
                        <div class="layui-form-item" style="margin-top: 20px;">
                            <table id="tableY" >
                                ...
                                <tr>
                                    ...
                                    <td>申请时间</td>
                                    <td colspan="2">${list.dimapplydate}</td>
                                </tr>
                                <tr>
                                    <td>离职类型</td>
                                    <td colspan="5">${list.dimtype}</td>
                                </tr>
                                <tr >
                                    <td >离职原因</td>
                                    <td colspan="5" style="height: 120px;">
                                        <textarea name="address" placeholder="请输入内容" style="width: 700px;height: 120px;" class="layui-textarea">${list.dimdetails}</textarea>
                                    </td>
                                </tr>
                                <tr >
                                    <td >对公司建议</td>
                                    <td colspan="5" style="height: 120px;">
                                        <textarea name="address" placeholder="请输入内容" style="width: 700px;height: 120px;" class="layui-textarea">${list.dimsuggest}</textarea>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="demoTable layui-form">
                        <div class="layui-inline">
                            ...
                            <input value="${list.dimid}" id="b" style="display: none;">
...
<script>
    function pass() {
        ...
        $.ajax({
            url:'UpdateApplyDimissionYqx',
            type:'post',
            data:{"empid":empid,"dimid":dimid,"name":name,"data":currentdate},
            dataType:'text',
            success:function (data) {
                alert(data+"ggggggggggggggg")
                window.location.href="QResignation"
            }
        })
    }
    function TurnDown() {
