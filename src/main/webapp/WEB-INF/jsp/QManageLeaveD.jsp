        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header" style="margin-top: 20px;">
                    <div  style="margin-left: 470px"><h1>请假审核</h1></div>
                </div>
                <div class="layui-card-body">
                        ...
                        <div class="layui-form-item" style="margin-top: 20px;">
                            <table id="tableY" >
                                ...
                                <tr>
                                    ...
                                    <td>申请时间</td>
                                    <td colspan="2">${list.shendate}</td>
                                </tr>
                                <tr>
                                    <td>假期类型</td>
                                    <td colspan="2">${list.leatype}</td>
                                    <td>休假天数</td>
                                    <td colspan="2">${list.leaday}</td>
                                </tr>
                                <tr>
                                    <td>开始时间</td>
                                    <td colspan="5">${list.leaenterdate}</td>
                                </tr>
                                <tr >
                                    <td >申请内容</td>
                                    <td colspan="5" style="height: 150px;">
                                        <textarea name="address" placeholder="请输入内容" style="width: 700px;height: 150px;" class="layui-textarea">${list.leareason}</textarea>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="demoTable layui-form">
                        <div class="layui-inline">
                            ...
                            <input value="${list.leaid}" id="b" style="display: none;">
...
<script>
    function pass() {
        ...
        $.ajax({
            url:'UpdateLeaveYqx',
            type:'post',
            data:{"leaid":leaid,"name":name,"data":currentdate},
            dataType:'text',
            success:function (data) {
                alert(data+"ggggggggggggggg")
                window.location.href="QManageLeave"
            }
        })
    }
    function TurnDown() {
